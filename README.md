...
[![Build Status](https://travis-ci.org/shupac/flex.svg?branch=master)](https://travis-ci.org/shupac/flex) [![Dependency Status](https://david-dm.org/shupac/flex.svg)](https://david-dm.org/shupac/flex) [![devDependency Status](https://david-dm.org/shupac/flex/dev-status.svg)](https://david-dm.org/shupac/flex#info=devDependencies)
